<?php /*a:2:{s:60:"E:\car_subsystem/application/webapi\view\contract\index.html";i:1541316396;s:60:"E:\car_subsystem/application/webapi\view\public\header2.html";i:1541059213;}*/ ?>
<html lang="en" data-dpr="1" style="font-size: 41.4px;">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <title>深圳车厘子-合同查看</title>
...
<div id="root">
    <div class="am-wingblank am-wingblank-lg applyConatiner___Z-1Gc">
        <section class="contentWrapper___rHVlL">
            ...
            <p>合同类型：<?php if($info['contract_type'] == 2): ?>订车合同<?php else: ?>定车合同<?php endif; ?></p>
            ...
            <div class="info row-s">
                ...
                <div class="col-12-8 text-right">
                    <?php echo htmlentities($info['nickname']); ?>
                </div>

                <div class="col-12-4 text-left col-888">
                    手机号码：
                </div>
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['phone']); ?>
                </div>
                ...
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['identify']); ?>
                </div>
                ...
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['emergency_contact']); ?>
                </div>
                ...
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['emergency_phone']); ?>
                </div>
            </div>
            <div class="divider___3fgf_"></div>
            <h3>车辆信息</h3>
            <div class="info row-s">
                ...
                <div class="col-12-8 text-right auth">
                    <?php if($info['car_type'] == 0): ?>中规车<?php else: ?>平行进口车<?php endif; ?>
                </div>
                <div class="col-12-4 text-left col-888">
                    品牌：
                </div>
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['brand_name']); ?>
                </div>
                <div class="col-12-4 text-left col-888">
                    车型：
                </div>
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['car_model']); ?>
                </div>
                <div class="col-12-4 text-left col-888">
                    颜色：
                </div>
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['car_color']); ?>
                </div>
                <div class="col-12-4 text-left col-888">
                    选装：
                </div>
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['car_selection']); ?>
                </div>
                <div class="col-12-4 text-left col-888">
                    官方指导价：
                </div>
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['guidance_price']); ?>
                </div>
                <div class="col-12-4 text-left col-888">
                    成交价：
                </div>
                <div class="col-12-8 text-right auth">
                    <?php echo htmlentities($info['transaction_price']); ?>
                </div>
            </div>
            <div class="divider___3fgf_"></div>
            <h3>代办、精品</h3>
            <div class="info row-s">
                ...
                <div class="col-12-8 text-right auth">
                    <?php if(count($info['insurance_list']) == 0): ?>
                    无
                    <?php else: foreach($info['insurance_list'] as $key => $val): ?>
                ...
                <div class="col-12-8 text-right auth">
                    <?php if(count($info['product_list']) == 0): ?>
                    无
                    <?php else: foreach($info['product_list'] as $key => $val): ?>
                    <?php echo htmlentities($val); ?>,
                    <?php endforeach; endif; ?>
                </div>
                <div class="col-12-4 text-left col-888">
                ...
                <div class="col-12-8 text-right auth">
                    <?php if($info['purchase_tax'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                </div>
                ...
                <div class="col-12-8 text-right auth">
                    <?php if($info['license'] == ''): ?>不办理<?php else: ?><?php echo htmlentities($info['license']); endif; ?>
                </div>
                ...
                <div class="col-12-8 text-right auth">
                    <?php if($info['freight'] == 1): ?>是<?php else: ?>否<?php endif; ?>
                </div>
            </div>
            ...
            <div class="container___1F_I1" style="margin-top: 16px;">
                <div class="button___1dfGc"><a
                        ...
                        target="_blank" href="/static/pdf/contract_<?php echo htmlentities($info['contract_number']); ?>.pdf"><span
                        class="buttonText___3_BSg">合同下载</span></a></div>
            </div>
        </section>
    </div>
</div>
