<?php /*a:2:{s:57:"E:\car_subsystem/application/webapi\view\user\my_pay.html";i:1541320334;s:60:"E:\car_subsystem/application/webapi\view\public\header2.html";i:1541059213;}*/ ?>
<html lang="en" data-dpr="1" style="font-size: 41.4px;">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <title>深圳车厘子-我的付款</title>
        ...
        <section class="contentWrapper___rHVlL">
            ...
            <div class="info row-s">
                ...
                <div class="col-12-8 text-right">
                    <?php if($vo['status'] == 0): ?>确认中<?php elseif($vo['status'] ==
                    1): ?><i class="iconfont icon-detail_icon col-green"></i> 已确认<?php else: ?>审核失败<?php endif; ?>
                </div>
            </div>
            <div class="info row-s">
                <div class="col-12-4 text-left col-888">
            ...
            <div class="info row-s">
                ...
                <div class="col-12-8 text-right col-green">
                    <?php echo htmlentities($vo['money']); ?>
                </div>
            </div>
            <div class="info row-s">
                <div class="col-12-4 text-left col-888">
                ...
                <div class="col-12-8 text-right col-money">
                    <?php echo htmlentities($vo['surplus']); ?>
                </div>
            </div>
            <div class="divider___3fgf_"></div>
            <?php endforeach; ?>
