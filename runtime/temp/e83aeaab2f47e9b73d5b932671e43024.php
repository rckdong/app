<?php /*a:2:{s:56:"E:\car_subsystem/application/admin\view\staff\index.html";i:1533438529;s:59:"E:\car_subsystem/application/admin\view\public\content.html";i:1528743302;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <td class='text-left nowrap'>
                <?php echo htmlentities($vo['bumen']); ?>
            </td>
            <td class='text-left nowrap'>
                <?php echo htmlentities($vo['ganwei']); ?>
            </td>
            <td class='text-left nowrap'>
                <?php echo htmlentities($vo['pid_name']); ?>
            </td>
            <td class='text-left nowrap'>
