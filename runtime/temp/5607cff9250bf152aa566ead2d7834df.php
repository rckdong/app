<?php /*a:2:{s:70:"E:\car_subsystem/application/webapi\view\contract\get_pass_number.html";i:1541321949;s:60:"E:\car_subsystem/application/webapi\view\public\header2.html";i:1541059213;}*/ ?>
<html lang="en" data-dpr="1" style="font-size: 41.4px;">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <title>深圳车厘子-放行条</title>
    ...
    <div class="am-wingblank am-wingblank-lg applyConatiner___Z-1Gc">
        <section class="contentWrapper___rHVlL">
            ...
            <div class="info row-s">
                <div class="col-12-12 text-right col-888">
                    还未签合同
                </div>
            </div>
            <?php else: ?>
            <div class="car-info">
                <div class="info row-s">
                    <div class="col-12-12 text-right col-888">
                        <img style="width: 98%"
                             src="http://chexinyuan.com/creat_img.php?codes=<?php echo htmlentities((isset($contract_info['pass_code']) && ($contract_info['pass_code'] !== '')?$contract_info['pass_code']:'')); ?>"
                             alt="放行条"/>
                    </div>
                </div>
                ...
                <div class="info row-s">
                    ...
                    <div class="col-12-8 text-left col-green">
                        <?php echo htmlentities((isset($contract_info['brand_name']) && ($contract_info['brand_name'] !== '')?$contract_info['brand_name']:'暂无')); ?>
                    </div>
                </div>
                <div class="info row-s">
                    <div class="col-12-4 text-left col-888">
                    ...
                    <div class="col-12-8 text-left col-green">
                        <?php echo htmlentities((isset($contract_info['car_model']) && ($contract_info['car_model'] !== '')?$contract_info['car_model']:'暂无')); ?>
                    </div>
                </div>
                <div class="info row-s">
                    <div class="col-12-4 text-left col-888">
                    ...
                    <div class="col-12-8 text-left col-green">
                        <?php echo htmlentities((isset($contract_info['car_color']) && ($contract_info['car_color'] !== '')?$contract_info['car_color']:'暂无')); ?>
                    </div>
                </div>
                <div class="info row-s">
                    <div class="col-12-4 text-left col-888">
                    ...
                    <div class="col-12-8 text-left col-green">
                        <?php echo htmlentities((isset($contract_info['frame_number']) && ($contract_info['frame_number'] !== '')?$contract_info['frame_number']:'暂无')); ?>
                    </div>
                </div>


                <img src="<?php echo sysconf('fangxing_seal'); ?>" class="fangxingSeal" alt="章">
            </div>
            <?php endif; ?>
