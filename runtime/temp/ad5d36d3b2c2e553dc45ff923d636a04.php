<?php /*a:2:{s:62:"E:\car_subsystem/application/webapi\view\contract\baoxian.html";i:1541318103;s:60:"E:\car_subsystem/application/webapi\view\public\header2.html";i:1541059213;}*/ ?>
<html lang="en" data-dpr="1" style="font-size: 41.4px;">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <title>深圳车厘子-保单信息</title>
    ...
    <div class="am-wingblank am-wingblank-lg applyConatiner___Z-1Gc">
        <section class="contentWrapper___rHVlL">
            ...
            <div class="info row-s">
                <div class="col-12-12 text-left col-888 imgs-data">
                    <?php if($info['compulsory_image'] != ''): ?>
                    <img src="http://chexinyuan.com<?php echo htmlentities($info['compulsory_image']); ?>" data-preview-src="" data-preview-group="1"/>
                    <?php endif; if($info['commercial_image'] != ''): ?>
                    <img src="http://chexinyuan.com<?php echo htmlentities($info['commercial_image']); ?>" data-preview-src="" data-preview-group="1"/>
                    <?php endif; if($info['quality_image'] != ''): ?>
                    <img src="http://chexinyuan.com<?php echo htmlentities($info['quality_image']); ?>" data-preview-src="" data-preview-group="1"/>
                    <?php endif; if($info['compulsory_invoice_image'] != ''): ?>
                    <img src="http://chexinyuan.com<?php echo htmlentities($info['compulsory_invoice_image']); ?>" data-preview-src="" data-preview-group="1"/>
                    <?php endif; if($info['commercial_invoice_image'] != ''): ?>
                    <img src="http://chexinyuan.com<?php echo htmlentities($info['commercial_invoice_image']); ?>" data-preview-src="" data-preview-group="1"/>
                    <?php endif; if($info['quality_invoice_image'] != ''): ?>
                    <img src="http://chexinyuan.com<?php echo htmlentities($info['quality_invoice_image']); ?>" data-preview-src="" data-preview-group="1"/>
                    <?php endif; ?>
                </div>
            </div>
