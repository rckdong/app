<?php /*a:2:{s:57:"E:\car_subsystem/application/webapi\view\user\daiban.html";i:1541056989;s:60:"E:\car_subsystem/application/webapi\view\public\header2.html";i:1541059213;}*/ ?>
...
<div id="root">
    <div class="container___3Wps8">
        ...
        <?php if(empty($contract_info)): ?>
        <p>还未签合同</p>
        <?php else: ?>
        <p><span>合同类型</span>：<?php if($contract_info['contract_type'] == 2): ?>订车合同<?php else: ?>定车合同<?php endif; ?></p>
        <p><span>合同编号</span>：<?php echo htmlentities((isset($contract_info['contract_number']) && ($contract_info['contract_number'] !== '')?$contract_info['contract_number']:'')); ?></p>
        <?php endif; ?>
        <p><span>代办业务</span>,请您选择服务。</p>
        <div class="am-whitespace am-whitespace-lg"></div>
        <div class="am-whitespace am-whitespace-lg"></div>
        <a href="<?php echo url('webapi/contract/anjie'); ?>?contract_id=<?php echo htmlentities($contract_info['id']); ?>" style="width: 100%;">
            <div class="container___1F_I1">
                <div class="button___1dfGc hasIcon___3gONm">
                    ...
                    <span class="buttonText___3_BSg">按揭</span></div>
            </div>
        </a>
        <div class="am-whitespace am-whitespace-lg"></div>
        <a href="<?php echo url('webapi/contract/baoxian'); ?>?contract_id=<?php echo htmlentities($contract_info['id']); ?>" style="width: 100%;">
            <div class="container___1F_I1">
                <div class="button___1dfGc hasIcon___3gONm">
                    <svg class="am-icon am-icon-md " color="#fff">
                        <use xlink:href="#icon_check_progress" width="18" height="18"></use>
                    </svg>
                    <span class="buttonText___3_BSg">保险</span></div>
            </div>
        </a>
        <div class="am-whitespace am-whitespace-lg"></div>
        <a href="<?php echo url('webapi/contract/jingpin'); ?>?contract_id=<?php echo htmlentities($contract_info['id']); ?>" style="width: 100%;">
            <div class="container___1F_I1">
                <div class="button___1dfGc hasIcon___3gONm">
                    <svg class="am-icon am-icon-md " color="#fff">
                        <use xlink:href="#icon_card_add" width="18" height="18"></use>
                    </svg>
                    <span class="buttonText___3_BSg">精品</span></div>
            </div>
        </a>

        <div class="am-whitespace am-whitespace-lg"></div>
        <a href="<?php echo url('webapi/contract/shangpai'); ?>?contract_id=<?php echo htmlentities($contract_info['id']); ?>" style="width: 100%;">
            <div class="container___1F_I1">
                <div class="button___1dfGc hasIcon___3gONm">
                    <svg class="am-icon am-icon-md  " color="#fff">
                        <use xlink:href="#icon_terms" width="18" height="18"></use>
                    </svg>
                    <span class="buttonText___3_BSg">上牌</span></div>
            </div>
        </a>
    </div>
</div>
