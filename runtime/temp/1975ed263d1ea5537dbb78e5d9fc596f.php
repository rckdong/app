<?php /*a:2:{s:57:"E:\car_subsystem/application/webapi\view\user\gouche.html";i:1541056988;s:60:"E:\car_subsystem/application/webapi\view\public\header2.html";i:1541059213;}*/ ?>
...
<div id="root">
    <div class="container___3Wps8">
        ...
        <?php endif; ?>
        <p><span>我的购车</span>,请您选择服务。</p>
        <div class="am-whitespace am-whitespace-lg"></div>
        <div class="am-whitespace am-whitespace-lg"></div>
        <a href="<?php echo url('webapi/contract/index'); ?>" style="width: 100%;">
            <div class="container___1F_I1">
                <div class="button___1dfGc hasIcon___3gONm">
                    ...
                    <span class="buttonText___3_BSg">查看合同</span></div>
            </div>
        </a>
        <div class="am-whitespace am-whitespace-lg"></div>
        <a href="<?php echo url('webapi/contract/car_info'); ?>?contract_id=<?php echo htmlentities($contract_info['id']); ?>" style="width: 100%;">
            <div class="container___1F_I1">
                <div class="button___1dfGc hasIcon___3gONm">
                    <svg class="am-icon am-icon-md " color="#fff">
                        <use xlink:href="#icon_check_progress" width="18" height="18"></use>
                    </svg>
                    <span class="buttonText___3_BSg">车辆状态</span></div>
            </div>
        </a>
        <div class="am-whitespace am-whitespace-lg"></div>
