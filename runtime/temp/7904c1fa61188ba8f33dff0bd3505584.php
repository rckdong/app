<?php /*a:2:{s:62:"E:\car_subsystem/application/webapi\view\contract\jingpin.html";i:1541319932;s:60:"E:\car_subsystem/application/webapi\view\public\header2.html";i:1541059213;}*/ ?>
<html lang="en" data-dpr="1" style="font-size: 41.4px;">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
    <title>深圳车厘子-精品状态</title>
        ...
        <section class="contentWrapper___rHVlL">
            ...
            <div class="info row-s">
                <div class="col-12-4 text-left col-888">
                    <?php echo htmlentities($val['dotime']); ?>
                </div>
                <div class="col-12-8 text-right">
                    <?php if($val['status'] == 1): ?><i class="iconfont icon-detail_icon col-green"></i>  确认完成<?php else: ?>未完成<?php endif; ?>
                </div>
            </div>
            <div class="info row-s">
                <div class="col-12-12 text-left col-888">

                    <?php echo htmlentities((isset($val['name']) && ($val['name'] !== '')?$val['name']:'')); ?>
                </div>
            </div>
            <div class="divider___3fgf_"></div>
            <?php endforeach; ?>
