<?php /*a:2:{s:56:"E:\car_subsystem/application/admin\view\login\index.html";i:1528743302;s:56:"E:\car_subsystem/application/admin\view\public\main.html";i:1534260517;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
    <head>
        <meta charset="utf-8">
    ...
    <div class="container">
        <form onsubmit="return false;" data-time="0.001" data-auto="true" method="post" class="content layui-form animated fadeInDown">
            ...
            <ul>
                <li class="username">
                    <i></i>
                    <input required pattern="^\S{4,}$" name="username" value="admin" type="text" autofocus="autofocus" autocomplete="off" title="请输入4位及以上的字符" placeholder="请输入用户名">
                </li>
                <li class="password">
                    <i></i>
